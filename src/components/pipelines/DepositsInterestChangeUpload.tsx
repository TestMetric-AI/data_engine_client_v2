...
const fileNameRegex = /^deposits_interest_change\.[0-9]{8}\.csv$/;
...
export default function DepositsInterestChangeUpload() {
    ...
    async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        if (!isFileNameValid) {
            setError("El nombre debe ser deposits_interest_change.YYYYMMDD.csv.");
            return;
        }
        ...
        const url = `/api/deposits-interest-change${query}`;
        ...
        try {
            ...
            console.log("Deposits interest change upload response:", {
                ...
                <section className="rounded-2xl border border-border bg-surface p-4">
                    ...
                    {!isFileNameValid && file && (
                        <p className="mt-2 text-xs font-semibold text-rose-600">
                            El nombre debe ser deposits_interest_change.YYYYMMDD.csv
                        </p>
                    )}
                </section>
