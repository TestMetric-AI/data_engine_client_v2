...
const fileNameRegex = /^deposits_locked\.[0-9]{8}\.csv$/;
...
export default function DepositsLockedUpload() {
    ...
    async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        if (!isFileNameValid) {
            setError("El nombre debe ser deposits_locked.YYYYMMDD.csv.");
            return;
        }
        ...
        const url = `/api/deposits-locked${query}`;
        ...
        try {
            ...
            console.log("Deposits locked upload response:", {
                ...
                <section className="rounded-2xl border border-border bg-surface p-4">
                    ...
                    {!isFileNameValid && file && (
                        <p className="mt-2 text-xs font-semibold text-rose-600">
                            El nombre debe ser deposits_locked.YYYYMMDD.csv
                        </p>
                    )}
                </section>
