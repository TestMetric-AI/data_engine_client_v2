      ...
      <div className="rounded-2xl border border-border bg-card p-5 shadow-sm shadow-border/40 sm:p-6">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 font-display text-3xl font-semibold text-text-primary">Test Suites</h1>
            <p className="mt-2 text-sm text-text-secondary">
              Browse and filter test suite records captured from pipeline runs.
            </p>
