...
export default function PermissionForm({ initialData, onSuccess, onCancel }: PermissionFormProps) {
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="mt-4 flex justify-end gap-3">
                ...
                <button
                    ...
                    disabled={loading}
                >
                    {loading ? "Saving..." : initialData ? "Update Permission" : "Create Permission"}
                </button>
            </div>
        </form>
    );
