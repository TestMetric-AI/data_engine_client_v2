            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="relative">
                    <input
                        ...
                        className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 pl-10 text-sm text-slate-700 placeholder-slate-400 focus:border-slate-300 focus:outline-none focus:ring-0 w-full sm:w-64"
                    />
